"""Karnataka coastal safety advisory pipeline (telemetry, Sarvam, cache)."""
import os
...
from coastal_common.openmeteo import current_hour_index, fetch_forecast_hourly

ensure_repo_root_on_path(__file__)

from karnataka.actions import apply_action_templates
from karnataka.risk import (
...
from karnataka.storage import CACHE_FILE, REGISTRY_FILE, STATIONS_FILE, load_json, save_json
from karnataka.tides import compute_tide_timing
from karnataka.weather import (
    TIMEZONE,
...
def process_coastal_safety(station, audience=None):
    ...
    idx = current_hour_index(times, now_ist)
    ...
    risk_level = compute_risk_level(
        current_wind, current_wave, seasonal_elevated=in_monsoon
    )
