"""Flask webhooks for Karnataka WhatsApp / SMS / voice coastal safety advisories."""
import traceback
...
from karnataka.actions import parse_audience, truncate_for_whatsapp
from karnataka.safety import (
